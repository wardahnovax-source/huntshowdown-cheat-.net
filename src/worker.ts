 ...
 * Canonical site: https://huntshowdowncheat.net (matches brand.url)
 *
 * Requires DNS: CNAME `www` → `huntshowdowncheat.net` (proxied) AND
 * Workers custom domain `www.huntshowdowncheat.net` attached — otherwise
...
const CANONICAL_HOST = 'huntshowdowncheat.net';

/** Old apex still 301 → current canonical. */
const LEGACY_HOSTS = new Set(['www.huntshowdowncheat.net']);
