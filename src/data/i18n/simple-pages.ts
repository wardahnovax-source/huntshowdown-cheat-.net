...
export const simplePageCopy: Partial<Record<PageId, SimplePageCopy>> = {
		...
		sections: [
			{
				h2: 'ESP & wallhack',
				paragraphs: [
					'See Hunters, AI, bosses, clues, and loot through walls with distance readouts.',
					'Use filters so the overlay stays clear in compounds, fog, and bounty chaos.',
				],
				list: ['Hunter ESP & distance', 'Weapon, loot, clue, and bounty ESP', 'AI / boss and extraction filters'],
			},
			{
				h2: 'Aimbot & FOV',
				paragraphs: [
					'Aim help you can tune to feel natural.',
					'Set FOV, smoothness, and bone priority per weapon before you hunt.',
				],
				list: ['Aim smoothness', 'FOV and bone priority', 'Hotkeys mid-match'],
			},
			{
				h2: 'Extraction ESP',
				paragraphs: [
					'Mark extraction points and nearby threats outside your view.',
					'Spot flanks near extracts without filling the whole screen.',
				],
				list: ['Extraction point ESP', 'Bounty carrier cues', 'Adjustable range'],
			},
			{
				h2: 'Updates & support',
				paragraphs: [
		...
		sections: [
			{
				...
				paragraphs: [
					...
					'Same Hunter ESP, aimbot, and loot ESP on monthly and lifetime plans.',
				],
				list: ['ESP, aimbot, and extraction tools', 'Patch rebuilds while active', 'Digital delivery after checkout'],
			},
			{
				h2: 'Plans',
				paragraphs: [
	...
	updates: page({
		...
		ctaPrimary: brandCopy.ctaBuy,
		ctaSecondary: 'Hunt: Showdown Cheats overview',
		...
		sections: [
			{
				h2: 'Current status',
				paragraphs: [
					'As of 4 Sep 2026 the package is online for Hunt: Showdown on Windows PC. We post a new note here when a game or Easy Anti-Cheat patch needs a rebuild.',
					'If Status is green, you can hunt. If we are rebuilding, wait for the next note.',
				],
				list: [
					'Check this page before every bounty hunt after a patch',
	...
	hacks: page({
		...
		h1: 'HUNT:SHOWDOWN CHEATS',
		intro: brandCopy.previewIntro,
		ctaPrimary: brandCopy.ctaBuy,
		ctaSecondary: 'View features',
		ctaSecondaryHref: '/features/',
		galleryTitle: 'In-hunt look',
		sections: [
			{
				h2: 'What you get',
				paragraphs: [
					'One license for Hunt: Showdown on Windows PC — built for bounty hunts and compound clears.',
				],
				list: [
					'Hunter ESP with distance',
					'Aimbot FOV & smoothness',
					'AI / boss, loot, clue, and extraction ESP',
					'Easy Anti-Cheat rebuilds after patches',
				],
			},
			{
				h2: 'Built for Hunt: Showdown bounty hunts',
				paragraphs: [
					'Read Hunters and bosses before you push, mark loot and clues, and stay aware near extraction. Tune aimbot FOV per weapon for close compounds and long swamp shots.',
				],
				list: [
					'<a href="/hunt-showdown-esp/">ESP guide</a>',
					'<a href="/hunt-showdown-aimbot/">Aimbot controls</a>',
					'<a href="/hunt-showdown-extraction-esp/">Extraction ESP</a>',
	...
	'hunt-showdown-esp': page({
		title: 'Hunt: Showdown ESP | {brand}',
		description:
			'Hunt Showdown Hunter ESP and wallhack for Windows PC — player boxes, skeleton ESP, distance, loot, clues, and bosses.',
		h1: 'ESP',
		intro: 'See Hunters, AI, bosses, clues, and loot through walls. Part of the same {brand} license.',
		ctaPrimary: brandCopy.ctaBuy,
		ctaSecondary: 'Hunt: Showdown Cheats overview',
		ctaSecondaryHref: '/hunt-showdown-cheats/',
		galleryTitle: 'ESP in hunt',
		sections: [
			{
				h2: 'What ESP shows',
				paragraphs: ['Boxes, skeletons, distance, and filters for Hunters, AI, bosses, weapons, and loot.'],
				list: ['Hunter ESP', 'AI / boss ESP', 'Weapon, loot, clue, and bounty ESP'],
			},
			{
				h2: 'When to use it',
				paragraphs: ['Clear compounds and fog without flooding the screen. Customizable colors and range.'],
				list: ['Tune opacity', 'Filter noise', 'Pair with extraction ESP'],
			},
			{
				h2: 'Next steps',
				paragraphs: ['ESP is included with aimbot and radar in one plan.'],
				list: [
					'<a href="/hunt-showdown-cheats/">Full product</a>',
	...
	'hunt-showdown-aimbot': page({
		title: 'Hunt: Showdown Aimbot | {brand}',
		description:
			'Hunt: Showdown aimbot and soft aim for Hunt: Showdown on Windows PC — FOV, smoothness, and bone priority you can tune per weapon.',
		h1: 'Aimbot',
		intro: 'Soft aim and aim assist you can tune for Hunt: Showdown. Included in the same {brand} license.',
		ctaPrimary: brandCopy.ctaBuy,
		ctaSecondary: 'Hunt: Showdown Cheats overview',
		ctaSecondaryHref: '/hunt-showdown-cheats/',
	...
	radar: page({
		title: 'Hunt: Showdown Extraction ESP | {brand}',
		description:
			'Hunt Showdown extraction ESP for Windows PC — extraction points, bounty carriers, and flank cues without filling the screen.',
		h1: 'Extraction ESP',
		intro: 'Mark extraction points and threats outside your view. Included in the same {brand} license.',
		ctaPrimary: brandCopy.ctaBuy,
		ctaSecondary: 'Hunt: Showdown Cheats overview',
		ctaSecondaryHref: '/hunt-showdown-cheats/',
		galleryTitle: 'Extraction overlay',
		sections: [
			{
				h2: 'What it shows',
				paragraphs: ['Extraction points, bounty carriers, and nearby Hunter cues with adjustable range.'],
				list: ['Extraction point ESP', 'Bounty carrier ESP', 'Adjustable range'],
			},
			{
				h2: 'With Hunter ESP',
				paragraphs: ['Use extraction ESP for routes you cannot see yet. Use Hunter ESP when you push.'],
				list: [
					'<a href="/hunt-showdown-esp/">ESP guide</a>',
					'<a href="/hunt-showdown-cheats/">Full product</a>',
					'<a href="/pricing/">Store</a>',
