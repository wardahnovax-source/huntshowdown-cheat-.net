...
const imageMap: Record<BlogImageKey, string> = {
	hero: huntImages.espWallhack,
	espWallhack: huntImages.espWallhack,
	aimbotCombat: huntImages.aimbotCombat,
	aimbotSkeleton: huntImages.aimbotSkeleton,
	squadFight: huntImages.aimbotCombat,
	headerArt: huntImages.playerEsp,
	cheatsPackage: huntImages.espWallhack,
	playerEsp: huntImages.playerEsp,
	rebootFight: huntImages.aimbotCombat,
	battleRoyaleCombat: huntImages.cheatsCombat,
	battleRoyaleIslandMap: huntImages.espWallhack,
};

const FALLBACK_BLOG_IMAGE = huntImages.espWallhack;
...
export function getBlogSitemapEntriesForLocale(locale: LocaleCode) {
	...
	for (const post of blogPosts) {
		...
		const isProductPost = /Hunt: Showdown Cheats|Aimbot|ESP|Undetected|Comparisons/i.test(post.category);
		entries.push({
