...
const defaultImages: BrandSitemapImage[] = [
	{
		...
		title: 'Hunt Showdown cheats esp',
		caption: 'Hunt Showdown cheats esp wallhack',
	},
	{
		src: '/images/hunt-showdown-cheats-wallhack.webp',
		title: 'Hunt Showdown cheats wallhack',
		caption: 'Hunt Showdown cheats wallhack esp',
	},
	{
		src: '/images/hunt-showdown-cheats-aimbot.webp',
		title: 'Hunt Showdown cheats aimbot',
		caption: 'Hunt Showdown cheats aimbot soft aim',
	},
	{
		src: '/images/hunt-showdown-cheats-aimbot-view.webp',
		title: 'Hunt Showdown cheats aimbot',
		caption: 'Hunt Showdown cheats aimbot view',
	},
	{
		src: '/images/hunt-showdown-cheats-extraction.webp',
		title: 'Hunt Showdown cheats radar',
		caption: 'Hunt Showdown cheats extraction ESP',
	},
	{
		src: '/images/hunt-showdown-cheats-bounty.webp',
		title: 'Hunt Showdown cheats',
		caption: 'Hunt Showdown cheats in raid',
	},
];
...
const pageImageTemplates: Record<PageId, { title: string; caption: string }> = {
	home: { title: '{brand} hero — ESP and aimbot in Hunt: Showdown', caption: 'Homepage preview of {primaryKeyword} on Windows PC' },
	'hunt-showdown-esp': { title: '{primaryKeyword} ESP overlay', caption: 'Player ESP boxes and distance with {primaryKeyword}' },
	'hunt-showdown-aimbot': { title: '{primaryKeyword} aimbot view', caption: 'Aimbot and soft aim controls in {primaryKeyword}' },
	...
	radar: { title: '{primaryKeyword} radar', caption: 'Extraction ESP map cues in {primaryKeyword}' },
	eac: { title: '{antiCheat} and {primaryKeyword}', caption: '{primaryKeyword} rebuilds after a Easy Anti-Cheat update' },
	'cheats-2026': { title: '{primaryKeyword} overview', caption: '{primaryKeyword} for Hunt: Showdown on PC' },
