	...
	const categories = [
		{
			...
			links: [
				...
				{ href: '/hunt-showdown-esp/', labelKey: 'homeSeo.linkEsp' },
				{ href: '/hunt-showdown-aimbot/', labelKey: 'homeSeo.linkAimbot' },
				{ href: '/hunt-showdown-extraction-esp/', labelKey: 'homeSeo.linkRadar' },
			],
		},
		{
			...
			links: [
				...
				{ href: '/hunt-showdown-cheats/', labelKey: 'homeSeo.linkUndetected' },
		...
		},
		{
			...
			links: [
				...
				{ href: '/hunt-showdown-cheats/', labelKey: 'homeSeo.linkHunt: ShowdownCheats' },
				{ href: '/features/', labelKey: 'homeSeo.linkAllFeatures' },
			],
		},
		{
