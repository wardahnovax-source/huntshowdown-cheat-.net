#!/usr/bin/env node
/**
 * Ports the 8 posts from ../hunt-showdown-blog into src/data/blog/posts.generated.ts
...
const SOURCE_DIR = join(ROOT, '..', 'hunt-showdown-blog', 'src', 'content', 'posts');
const OUT = join(ROOT, 'src', 'data', 'blog', 'posts.generated.ts');

const CATEGORY_NAMES = {
	'battle-royale-meta': 'raid Meta',
	'zero-build-strategies': 'compound clear',
...
for (const file of POST_FILES) {
	...
	sources.push({
		...
		intro: post.excerpt,
		keywords: [...post.tags, 'hunt-showdown intel'],
...
const file = `/* Auto-generated by scripts/port-from-hunt-showdown-blog.mjs — do not edit by hand. */
