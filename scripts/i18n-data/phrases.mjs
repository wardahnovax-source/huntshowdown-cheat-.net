...
const KW = {
	...
	cheats: 'Hunt Showdown cheats',
	hack: 'Hunt Showdown cheat',
	esp: 'Hunt Showdown ESP',
	wallhack: 'ESP wallhack',
	radar: 'extraction ESP',
	aimbot: 'Hunt Showdown aimbot',
...
export const phrases = {
	es: {
		buy: 'Comprar Hunt: Showdown Cheats', undetected: 'indetectables', maps: 'Stillwater Bayou, Lawson Delta, and DeSalle',
		...
		legal: () => 'Contacta support@huntshowdowncheat.net para solicitudes legales o de soporte.',
	},
	fr: {
		buy: 'Acheter Hunt: Showdown Cheats', undetected: 'indétectables', maps: 'Stillwater Bayou, Lawson Delta, and DeSalle',
		...
		legal: () => 'Contactez support@huntshowdowncheat.net pour le support ou les demandes légales.',
	},
	de: {
		buy: 'Hunt: Showdown Cheats kaufen', undetected: 'undetected', maps: 'Stillwater Bayou, Lawson Delta, and DeSalle',
		...
		legal: () => 'support@huntshowdowncheat.net für Support und rechtliche Anfragen.',
	},
	pt: {
		buy: 'Comprar Hunt: Showdown Cheats', undetected: 'indetectáveis', maps: 'Stillwater Bayou, Lawson Delta, and DeSalle',
		...
		legal: () => 'Contacte support@huntshowdowncheat.net para suporte ou questões legais.',
	},
	it: {
		buy: 'Acquista Hunt: Showdown Cheats', undetected: 'indetectable', maps: 'Stillwater Bayou, Lawson Delta, and DeSalle',
		...
		legal: () => 'Contatta support@huntshowdowncheat.net per supporto o richieste legali.',
	},
	nl: {
		buy: 'Hunt: Showdown Cheats kopen', undetected: 'undetected', maps: 'Stillwater Bayou, Lawson Delta, and DeSalle',
		...
		legal: () => 'support@huntshowdowncheat.net voor support en juridische vragen.',
	},
	pl: {
		buy: 'Kup Hunt: Showdown Cheats', undetected: 'undetected', maps: 'Stillwater Bayou, Lawson Delta, and DeSalle',
		...
		legal: () => 'support@huntshowdowncheat.net w sprawach wsparcia i prawnych.',
	},
	ru: {
		buy: 'Купить Hunt: Showdown Cheats', undetected: 'undetected', maps: 'Stillwater Bayou, Lawson Delta, and DeSalle',
		...
		legal: () => 'support@huntshowdowncheat.net для поддержки и юридических вопросов.',
	},
	tr: {
		buy: 'Hunt: Showdown Cheats satın al', undetected: 'undetected', maps: 'Stillwater Bayou, Lawson Delta, and DeSalle',
		...
		legal: () => 'Destek ve yasal sorular için support@huntshowdowncheat.net.',
	},
	ar: {
		buy: 'اشترِ Hunt: Showdown Cheats', undetected: 'غير مكتشف', maps: 'Stillwater Bayou, Lawson Delta, and DeSalle',
		...
		legal: () => 'support@huntshowdowncheat.net للدعم والطلبات القانونية.',
	},
	ja: {
		buy: 'Hunt: Showdown Cheatsを購入', undetected: 'undetected', maps: 'Stillwater Bayou, Lawson Delta, and DeSalle',
		...
		legal: () => 'サポート・法務: support@huntshowdowncheat.net',
	},
	ko: {
		buy: 'Hunt: Showdown Cheats 구매', undetected: 'undetected', maps: 'Stillwater Bayou, Lawson Delta, and DeSalle',
		...
		legal: () => '지원 및 법무: support@huntshowdowncheat.net',
	},
	zh: {
		buy: '购买 Hunt: Showdown Cheats', undetected: 'undetected', maps: 'Stillwater Bayou, Lawson Delta, and DeSalle',
		...
		legal: () => '支持与法务：support@huntshowdowncheat.net',
	},
	hi: {
		buy: 'Hunt: Showdown Cheats खरीदें', undetected: 'undetected', maps: 'Stillwater Bayou, Lawson Delta, and DeSalle',
		...
		legal: () => 'सहायता: support@huntshowdowncheat.net',
	},
	id: {
		buy: 'Beli Hunt: Showdown Cheats', undetected: 'undetected', maps: 'Stillwater Bayou, Lawson Delta, and DeSalle',
		...
		legal: () => 'support@huntshowdowncheat.net untuk dukungan dan legal.',
	},
	th: {
		buy: 'ซื้อ Hunt: Showdown Cheats', undetected: 'undetected', maps: 'Stillwater Bayou, Lawson Delta, and DeSalle',
		...
		legal: () => 'support@huntshowdowncheat.net สำหรับการสนับสนุน',
	},
	vi: {
		buy: 'Mua Hunt: Showdown Cheats', undetected: 'undetected', maps: 'Stillwater Bayou, Lawson Delta, and DeSalle',
		...
		legal: () => 'support@huntshowdowncheat.net cho hỗ trợ và pháp lý.',
	},
	uk: {
		buy: 'Купити Hunt: Showdown Cheats', undetected: 'undetected', maps: 'Stillwater Bayou, Lawson Delta, and DeSalle',
		...
		legal: () => 'support@huntshowdowncheat.net для підтримки та правових питань.',
	},
	cs: {
		buy: 'Koupit Hunt: Showdown Cheats', undetected: 'undetected', maps: 'Stillwater Bayou, Lawson Delta, and DeSalle',
		...
		legal: () => 'support@huntshowdowncheat.net pro podporu a právní dotazy.',
	},
	ro: {
		buy: 'Cumpără Hunt: Showdown Cheats', undetected: 'undetected', maps: 'Stillwater Bayou, Lawson Delta, and DeSalle',
		...
		legal: () => 'support@huntshowdowncheat.net pentru suport și legal.',
	},
	sv: {
		buy: 'Köp Hunt: Showdown Cheats', undetected: 'undetected', maps: 'Stillwater Bayou, Lawson Delta, and DeSalle',
		...
		legal: () => 'support@huntshowdowncheat.net för support och juridik.',
	},
};
