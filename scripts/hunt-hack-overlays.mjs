/**
 * SVG overlay generators for Hunt Showdown cheats marketing images.
 * Composited on top of IGN Hunt: Showdown gameplay screenshots.
 */
...
/** Extraction ESP widget — bottom-left. */
...
export function buildOverlaySvg(width, height, preset) {
	...
	switch (preset) {
		...
		case 'loot':
			...
			body += espBox(width * 0.68, height * 0.52, width * 0.06, height * 0.08, 'extraction timer · 103m', '#fbbf24');
