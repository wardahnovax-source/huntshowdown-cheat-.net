...
const ENGLISH_PATHS = [
	...
	'/terms/',
	'/blog/',
	'/blog/hunt-showdown-compound clear-aggressive-strategies/',
	'/blog/hunt-showdown-loot-routes-guide/',
	'/blog/hunt-showdown-weapon-tier-list/',
	'/blog/hunt-showdown-skin-leaks-guide/',
	'/blog/hunt-showdown-tournament-meta-guide/',
	'/blog/hunt-showdown-pro-settings-guide/',
	'/blog/hunt-showdown-warmup-maps-ranked/',
	'/blog/hunt-showdown-patch-notes-guide/',
	'/blog/hunt-showdown-cheats-complete-guide-2026/',
	'/blog/escape-from-hunt-showdown-cheats-buyers-guide/',
	'/blog/hunt-showdown-cheats-2026-whats-new/',
	'/blog/hunt-showdown-aimbot-settings-guide/',
	'/blog/hunt-showdown-esp-wallhack-explained/',
	'/blog/undetected-hunt-showdown-cheats-eac/',
	'/blog/hunt-showdown-cheats-vs-cheatvault-comparison/',
	'/blog/elitefn-vs-hunt-showdown-cheats-two-week-test/',
	'/blog/hunt-showdown-cheats-vs-ghostware-features-pricing/',
	'/reviews/',
	'/reviews/hunt-showdown-aim-assist-review-xkrypt0/',
	'/reviews/hunt-showdown-esp-compound clear-review-buildsr4k/',
	'/reviews/hunt-showdown-cloud-dma-review-dma-wizard/',
	'/reviews/hunt-showdown-aim-assist-review-ctrl-player99/',
	'/reviews/hunt-showdown-cheat-setup-review-stormchaser07/',
	'/reviews/hunt-showdown-loot-esp-review-lootgoblinx/',
	'/reviews/hunt-showdown-aim-assist-raid-review-rankedgrind42/',
	'/reviews/hunt-showdown-extraction-esp-review-vanlifeeft/',
	'/reviews/hunt-showdown-eac-update-review-patchdaymike/',
	'/reviews/hunt-showdown-sniper-soft-aim-review-snipezonly/',
	'/faq/what-are-hunt-showdown-cheats/',
	'/faq/are-hunt-showdown-cheats-undetected-in-2026/',
	'/faq/pmc-raids-and-compound clears/',
	'/faq/esp-wallhack-radar-or-aimbot/',
	'/faq/how-are-licenses-delivered/',
	'/faq/where-to-check-updates/',
	'/faq/how-to-contact-support/',
	'/faq/what-is-a-hunt-showdown-wallhack/',
	'/faq/does-hunt-showdown-cheats-include-radar-hack/',
	'/faq/eac-anti-cheat-and-hunt-showdown-cheats/',
	'/faq/buy-undetected-hunt-showdown-cheats-windows-pc/',
];
...
function extractionLocs(xml) {
	return [...xml.matchAll(/<loc>([^<]+)<\/loc>/g)].map((m) => m[1]);
}

function extractionHreflangCount(xml, url) {
...
async function main() {
	...
	const indexLocs = extractionLocs(sitemapIndex);
	const enLocs = extractionLocs(sitemapEn);
	const i18nLocs = extractionLocs(sitemapI18n);
	const imageLocs = extractionLocs(sitemapImages);
	...
	const homeHreflang = extractionHreflangCount(sitemapEn, `${SITE}/`);
