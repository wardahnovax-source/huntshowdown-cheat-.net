...
const assetsDir =
	'C:/Users/Aman/.cursor/projects/c-Users-Aman-hunt-showdownhacks/assets';
...
const USER_SCREENSHOTS = [
	{
		...
		file: 'hunt-showdown-esp-player-tags.webp',
	},
	{
		source:
		...
		file: 'hunt-showdown-wallhack-skeleton.webp',
	},
	{
		source:
		...
		file: 'hunt-showdown-aimbot-sniper.webp',
	},
	{
		source:
		...
		file: 'hunt-showdown-aimbot-skeleton.webp',
	},
	{
		source:
		...
		file: 'hunt-showdown-esp-extraction.webp',
	},
	{
		source:
		...
		file: 'hunt-showdown-cheats-combat.webp',
	},
];
...
const REMOVE_PREFIXES = [
	'hunt-showdown-battle-royale-combat',
	'hunt-showdown-extraction-fight',
	'hunt-showdown-cheats-aimbot',
	'hunt-showdown-cheats-cover',
	'hunt-showdown-cheats-esp-wallhack',
	'hunt-showdown-cheats-hero',
	'hunt-showdown-cheats-logo',
	'hunt-showdown-cheats-package',
	'hunt-showdown-header-art',
	'hunt-showdown-loadout-builder',
	'hunt-showdown-player-esp',
	'hunt-showdown-compound clear-combat',
	'hunt-showdown-compound clear-mode',
	'hunt-showdown-squad-fight',
	'hunt-showdown-verdansk-map',
];

async function removeOldHunt: ShowdownImages() {
...
async function generateResponsiveVariants() {
	const heroSource = path.join(imagesDir, 'hunt-showdown-esp-player-tags.webp');
	const heroMeta = await sharp(heroSource).metadata();

	for (const width of HERO_WIDTHS) {
		if (heroMeta.width && width > heroMeta.width) continue;
		const file = `hunt-showdown-esp-player-tags-${width}w.webp`;
	...
	for (const { file } of USER_SCREENSHOTS) {
		if (file === 'hunt-showdown-esp-player-tags.webp') continue;
...
async function generateFavicons() {
	const logoPath = path.join(imagesDir, 'hunt-showdown-cheats-logo.png');
...
await removeOldHunt: ShowdownImages();
